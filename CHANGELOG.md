...
### Fixed
- Check `grep.glob` and `find.pattern` filename selectors against protected paths, preserve relative custom patterns such as `secrets/*`, and use the session working directory consistently for pathless file tools.
