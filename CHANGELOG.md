...
### Fixed
- Headless in-process subagents running in worktrees now honor the interactive parent's YOLO mode even when the runner supplies no conventional subagent session path or prompt metadata.
