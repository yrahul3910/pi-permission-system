...
### Added
- Added an active-turn runtime to Pi's `Working...` spinner. The runtime updates once per second and excludes time spent awaiting local or forwarded permission decisions.
